...
public class ReRegistration extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    DatabaseHelper db;
    String inputValue="";
    Button bRegister,btnSearch;
    public static EditText etName, etDOB, etPass, etPass1,etCity, etUser, etPhone, etAdharNo,etPhoneSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_re_registration);
       ...
       // tvUploadDocLink = (TextView) findViewById(R.id.tvUploadDocLink);
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String a = etPhoneSearch.getText().toString();

                SQLiteDatabase db1=db.getReadableDatabase();
                Cursor cursor=db1.rawQuery("select * from registerShop where Phone=?", new String[]{a});
                ...
                String output = "Name=" + name + "\nPhone=" + phone + "\nAadhar No=" + adharno;
                  //  inputValue = output;
                   ...
                   //  Toast.makeText(ReRegistration.this, "text: " + output, Toast.LENGTH_SHORT).show();
        ...
        etDOB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(ReRegistration.this,
        ...
        bRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.equals("") || name == null || etDOB.getText().equals("") || etDOB.getText() == null || phone.equals("") || phone == null || adhar.equals("") || adhar == null
                    ...
                    Toast.makeText(ReRegistration.this, "Fields cant be empty", Toast.LENGTH_LONG).show();
                } else {
                    if(phone.length()==10){
                        if(adhar.length()==12){
                            if (pass.equals(pass1)) {
                                if (db.insertData(name, dob, phone, adhar,city, user, pass, value)) {
                                    ...
                                    try {
                                        ...
                                        Intent i = new Intent(ReRegistration.this, Payment1.class);
                                        startActivity(i);
                                ...
                                Toast.makeText(ReRegistration.this, "Password don't match!", Toast.LENGTH_LONG).show();

                            }
                        }else{
                            Toast.makeText(ReRegistration.this, "Enter valid Adhar Number!", Toast.LENGTH_LONG).show();

                        }
                    }else{
                        Toast.makeText(ReRegistration.this, "Enter valid Phone number!", Toast.LENGTH_LONG).show();
...
//        tvUploadDocLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ReRegistration.this, UploadDocument.class));
            }
        });
*/
